...
export const getProductVali = Joi.object({
  body: {},
  params: { productSlug: Joi.string().required() },
  query: {},
});

export const addProductVali = Joi.object({
  body: {
...
export const updateProductVali = Joi.object({
  body: {
...
export const deleteProductVali = Joi.object({
  body: {},
  params: { productSlug: Joi.string().required() },
  query: {},
});
